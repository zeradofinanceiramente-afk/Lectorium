...
import { X, Download, Database, Check, Server, ScanLine, Calculator, FileText } from 'lucide-react';
...
export const OfflineDownloadModal: React.FC<Props> = ({ isOpen, onClose, onConfirm }) => {
